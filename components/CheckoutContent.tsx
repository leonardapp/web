...
const safeProduct = product;
  ...
  const subtotal = safeProduct.price * quantity;
      ...
      <div className="max-w-7xl mx-auto pt-28 pb-24 px-6 grid lg:grid-cols-3 gap-10">
        ...
        <div className="lg:col-span-2 bg-white rounded-3xl p-10 shadow-sm">
          ...
          <p className="mt-3 text-slate-500">
            Complete the information below to submit your hardware order.
            A member of the HOXXES Sales Team will contact you to confirm
            ...
            <div className="mt-6 space-y-4">
              ...
              <label className="flex items-center gap-3 border rounded-xl p-5 cursor-pointer">
                ...
                <div>
                  ...
                  <div className="text-sm text-slate-500">
                    Payment will be completed after your order has been
                    confirmed by the HOXXES Sales Team.
                  </div>
              ...
              <label className="flex items-center gap-3 border rounded-xl p-5 cursor-pointer">
                ...
                <div>
                  ...
                  <div className="text-sm text-slate-500">
                    Bank transfer instructions will be provided after
              ...
              <>
                <div className="mt-8 rounded-2xl border border-slate-200 bg-slate-50 p-6">
                  ...
                  <div className="mt-6 rounded-xl border border-amber-200 bg-amber-50 p-4">
                    ...
                    <p className="text-sm text-amber-800">
                      <strong>Payment Reference:</strong> Please include your
                      order number in the payment description. Your order will
                      be processed after the payment has been verified.
                    </p>
                ...
                <div className="mt-8 rounded-2xl border border-blue-200 bg-blue-50 p-6">
                  ...
                  <ol className="mt-4 list-decimal list-inside space-y-3 text-sm text-blue-900">

                    <li>
                      Complete the bank transfer using the account details
                      above.
                    </li>
        ...
        <div>
          ...
          <div className="sticky top-20 rounded-3xl bg-white p-8 shadow-sm">
            ...
            <p className="mt-6 text-center text-sm leading-relaxed text-slate-500">
              By submitting this order, you acknowledge that product
              availability, payment details and fulfillment will be confirmed
              by the HOXXES Sales Team before your order is processed.
            </p>

            <Link
              href="/hardware"
              className="mt-6 block text-center text-slate-500 transition hover:text-black"
            >
              Continue Shopping
            </Link>
